...
ALARM_PATH := vendor/ozone/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ozone/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ozone/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/ozone/prebuilt/common/media/audio/ui
