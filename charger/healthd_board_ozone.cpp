...
void healthd_board_init(struct healthd_config*)
{
    ...
    int scale_fps;  // Not in use (charger/ozone_battery_scale doesn't have FPS text
                    // chunk). We are using hard-coded frame.disp_time instead.

    rc = res_create_multi_display_surface("charger/ozone_battery_scale",
